...
const EnterInRoomForm = (props) => {
    ...
    const onSubmit = (event) => {
        AddPlayerToRoom(event, props.router);
    };

    return (
        <form name="ytest" onSubmit={onSubmit} className="w-3/4 bg-gray-100 px-4 py-5 rounded-lg max-w-[300px] max-h-[350px]">
            <div className="mb-5">
